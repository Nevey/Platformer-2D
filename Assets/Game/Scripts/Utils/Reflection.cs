    ...
    public static class Reflection
    {
        ...
        public static MethodInfo[] GetMethodsWithCustomAttribute<T>() where T : Attribute
        {
            ...
            foreach (Assembly appDomain in assemblies)
            {
                ...
                {
                    throw new Exception($"Error while loading types for domain {appDomain.FullName}: {ex.Message}");
                }
            }
        ...
        public static FieldInfo[] GetFieldsWithAttribute<T>(object obj) where T : Attribute
        {
            Type type = obj.GetType();
